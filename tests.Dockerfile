...
RUN apt-get install -y wget curl python3 python3-pip wget libboost-python-dev libboost-dev build-essential zlib1g-dev libboost-system-dev libboost-program-options-dev libarmadillo-dev libboost-numpy-dev
